...
export default function UpcomingEarnings() {
    return (
            <div class="shadow-lg rounded-2xl m-10 bg-white dark:bg-[rgb(44,41,41)] sticky top-20">
                <div class="flex flex-wrap overflow-hidden p-10">
                    <h1 className='dark:text-gray-200 font-semibold mb-10'>Upcoming Earnings</h1>
